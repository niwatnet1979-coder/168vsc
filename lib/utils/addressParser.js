/**
 * Universal Address Parser - Version 3.4
 * Fixed Phone regex consuming house numbers & Reverted aggressive split point
 */

const PARSER_VERSION = '3.4';
...
function extractAddressComponents(addressText) {
    ...
    const extract = (regex, field) => {
        ...
        console.log(`  Working text (raw):`, JSON.stringify(working));
