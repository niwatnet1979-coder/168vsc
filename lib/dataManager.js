    ...
    getOrderById: async (id) => {
        ...
        try {
            ...
            return {
                ...
                status: data.status,
                deposit: data.deposit || { mode: 'percent', value: 0 },
    ...
    saveOrder: async (orderData) => {
        try {
            ...
            const orderPayload = {
                ...
                customer_details: orderData.customerDetails, // Save full customer object with contacts, addresses, taxInvoices
            ...
            const jobsPayload = orderData.items
                ...
                .map(item => ({
                    ...
                    product_snapshot: {
                        ...item,
                        image: undefined, // Remove base64 image to reduce DB size
                        subJob: undefined, // Remove subJob - redundant with jobs table
                        description: undefined, // Remove description - redundant with name
