...
export const showSelectVariant = async ({
    ...
    return Swal.fire({
        ...
        title: 'เลือก Variant',
        html: `
            <div id="swal-variant-list" class="flex flex-col gap-3 mt-4 max-h-[400px] overflow-y-auto pr-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                ${variants.map((v, i) => `
                    <div 
                        id="variant-opt-${i}"
    ...
    return Swal.fire({
        ...
        html: `
            <div class="flex flex-col gap-4">
                ...
                <div id="swal-product-list" class="flex flex-col gap-3 min-h-[100px] max-h-[400px] overflow-y-auto pr-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                    ${renderList(products)}
                </div>
