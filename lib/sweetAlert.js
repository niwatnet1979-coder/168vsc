    ...
    return Swal.fire({
        ...
        html: `
            <style>
                ...
                #swal-variant-list::-webkit-scrollbar {
                    display: none !important;
                }
            </style>
            <div id="swal-variant-list" class="flex flex-col gap-3 mt-4">
                ${variants.map((v, i) => `
                    <div 
                        id="variant-opt-${i}"
    ...
    return Swal.fire({
        ...
        html: `
            <style>
                ...
                #swal-product-list::-webkit-scrollbar {
                    display: none !important;
                }
            </style>
            <div class="flex flex-col gap-4">
                ...
                <div id="swal-product-list" class="flex flex-col gap-3 min-h-[100px]">
                    ${renderList(products)}
                </div>
