            ...
            const { data, error } = await supabase
                ...
                .select(`
                    *,
                    ...
                    siteAddressRecord:customer_addresses!location_id(*),
                    siteInspectorRecord:customer_contacts!inspector_id(*),
                    teamPayment:team_service_fees!team_payment_id(*)
                `)
    ...
    saveJob: async (jobData) => {
        try {
            ...
            const updatePayload = {
                ...
                appointment_date: jobData.appointmentDate || jobData.jobDate, // Support both UI and Mobile keys
        ...
        try {
            ...
            return {
                ...
                product: {
                    ...
                    ...variant, // Include variant specifics if needed
                    variant_id: job.orderItem?.product_variant_id
                },
                ...
                // Team Payment
                teamPaymentBatch: job.teamPayment,
                teamPaymentBatchId: job.team_payment_id
            }
        } catch (error) {
