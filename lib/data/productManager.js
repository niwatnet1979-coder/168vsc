    ...
    try {
        ...
        return products.map(p => {
            ...
            return {
                ...
                id: p.product_code,             // Map ID to Code for Frontend Compatibility (Display ID)
                db_id: p.uuid,                  // Alias for clarity if needed
                name: p.name,
                category: p.category,
...
export const saveProduct = async (productData) => {
    try {
        ...
        return {
            ...
            id: savedProduct.product_code, // Use product_code as ID for frontend
    ...
    try {
        ...
        if (error) {
            ...
            if (error.code === '23503') {
                return {
                    success: false,
                    error: 'ไม่สามารถลบสินค้านี้ได้ เนื่องจากมีการใช้งานอยู่ในใบสั่งซื้อ (Order) หรือใบเสนอราคา (Quotation) \n\nกรุณาลบรายการออเดอร์ที่เกี่ยวข้องออกก่อน จึงจะสามารถลบสินค้านี้ได้'
                }
            }
