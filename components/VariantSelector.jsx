            ...
            <Combobox value={value} onChange={onChange} disabled={disabled}>
                <div className="relative">
                    <div className="relative w-full">
                        <Combobox.Input
                            className={`w-full bg-transparent border-none p-0 text-sm font-medium text-secondary-900 focus:ring-0 ${disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
                            displayValue={(index) => variants[index]?.sku || ''}
                    ...
                    <Combobox.Options
                        className="absolute z-[100] mt-2 w-[calc(100%+2rem)] -left-4 bg-white rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none flex flex-col overflow-hidden"
                    >
